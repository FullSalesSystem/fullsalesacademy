...
const clientLogos = [
  { src: '/assets/cliente-ajs.webp',       name: 'AJS' },
  { src: '/assets/cliente-dm.webp',        name: 'DM' },
  { src: '/assets/cliente-hotelaria.webp', name: 'Hotelaria' },
  { src: '/assets/cliente-instituto.webp', name: 'Instituto' },
  { src: '/assets/cliente-kaizen.webp',    name: 'Kaizen' },
  { src: '/assets/cliente-maximus.webp',   name: 'Maximus' },
  { src: '/assets/cliente-mbi.webp',       name: 'MBI' },
  { src: '/assets/cliente-mental.webp',    name: 'Mental One' },
  { src: '/assets/cliente-perpetuo.webp',  name: 'Perpétuo' },
  { src: '/assets/cliente-positiva.webp',  name: 'Positiva' },
  { src: '/assets/cliente-salvus.webp',    name: 'Salvus' },
  { src: '/assets/cliente-taugor.webp',    name: 'Taugor' },
  { src: '/assets/cliente-ticto.webp',     name: 'Ticto' },
  { src: '/assets/cliente-tio.webp',       name: 'Tio' },
]
const areas1 = [
